...
<head>
    ...
    <style>
        ...
        .sidebar .lni-apartment::before { content: '\2302'; }
        ...
        .lni-save::before { content: '\1F4BE'; font-family: Arial, sans-serif; }
        .lni-plus::before { content: '+'; font-family: Arial, sans-serif; }
        .lni-minus::before { content: '\2212'; font-family: Arial, sans-serif; }
        .lni-reload::before { content: '\21BB'; font-family: Arial, sans-serif; }
        ...
        .panel {
            border-radius: 18px;
            box-shadow: 0 12px 30px rgba(20, 58, 52, .06);
        }
        ...
        .stat-card-modern {
            ...
            border: 1px solid #dfebe8 !important;
            box-shadow: 0 10px 24px rgba(20, 58, 52, .06) !important;
        }
        ...
        .stat-card-modern::before {
            ...
            bottom: 0;
            width: 5px;
            background: var(--card-accent, #0d7c66);
        }
        ...
        .stat-card-modern.accent-red { --card-accent: #c85654; }
...
<div class="dash-wrap">
    ...
    <main class="main-content">
        <div class="topbar">
            ...
            <div class="user-chip"><i class="lni lni-user"></i> <?= clean($_SESSION['admin_nama'] ?? 'Admin') ?></div>
        </div>
        <?php show_flash(); ?>
